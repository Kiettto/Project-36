class Question {
  ...
  display(){
    ...
    this.question.html("Question: What are two things you can never eat for breakfast? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Banana " );
    this.option1.position(150, 100);
    this.option2.html("2: Chocolate" );
    this.option2.position(150, 120);
    this.option3.html("3: Lunch and dinner " );
    this.option3.position(150, 140);
    this.option4.html("4: Cereal" );
